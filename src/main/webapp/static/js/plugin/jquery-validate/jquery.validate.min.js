			...
			.extend(
					$.validator,
					{
						...
						messages : {
							...
							number : "Please Enter a Numbers only",
...
(function($) {
	$.extend($.fn, {
	 ...
	 $.validator.addMethod("AppDate", function (value, element) {
	        var currVal = value;
	    if(currVal == '')
	        return true;
...
$.validator.addMethod("AppDateTime",function(value, element) {
    ...
    return this.optional(element) || (true && validTime);
}, "Please enter a date Time(	24 Hours) in the format dd/mm/yyyy hh:mm.");

$.validator.addMethod("AppTime",function(value, element) {
    var validTime = /^(([0-1]?[0-9])|([2][0-3])):([0-5]?[0-9])(:([0-5]?[0-9]))?$/i.test(stamp[1]);
    return this.optional(element) || validTime;
}, "Please enter a Time(24 Hours) in the format hh:mm.");
...
$.validator.addMethod("alternate_field", function(value, element, options) {
	var validator = this;
