                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Co-founders</h4>
                                   ...
                                   <div class="row">    
                                       <div class="col-lg-12">                                                                                   
                                                ...
                                                <div class="col-sm-6">
                                                 ...
                                                 <label for="example-text-input" class="col-sm-2 col-form-label text-left">CEO LinkedIn</label>
                                                 <div class="col-sm-6">
                                                    <input class="form-control form-control-sm" type="text" id="example-text-input-sm" style="border-color: #656d9a" name="firstName">
                                                </div>
                                                
                                                 </div><div class="form-group row">
                                                <label for="example-text-input" class="col-sm-2 col-form-label text-left">Co-founder Name</label>
                                                 <div class="col-sm-6">
                                                    <input class="form-control form-control-sm" type="text" id="example-text-input-sm" style="border-color: #656d9a" name="middleName">
                                                </div>
                                                
                                                 </div><div class="form-group row">
                                                <label for="example-text-input" class="col-sm-2 col-form-label text-left">Co-founder LinkedIn</label>
                                                 <div class="col-sm-6">
...
<script>
  ...
  $(document).ready(function(){
	...
	$('#aboutus').click();
	$("#img-cofounder").attr("src",path+"/static/assets/images/cofounders18blue.png");		
  });
