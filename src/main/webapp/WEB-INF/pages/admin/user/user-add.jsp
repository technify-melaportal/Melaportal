                        ...
                        <div class="col-lg-6">
                         	<div class="form-group">
                                <label for="example-email-input">Last Name</label>
                                    <input class="form-control" type="text" id="lastname" name="lastName" onchange="username()" required="name" autocomplete="off" style="text-transform:capitalize;">
                            </div> 
                            
                            <div class="form-group">
                                <label for="example-tel-input">initial</label>
                                    <input class="form-control" type="text" id="example-tel-input" name="initial" required="required" id="init" autocomplete="off" style="text-transform:uppercase;">
                            </div>
                            
                            <div class="form-group">
                                <label for="example-search-input">Email</label>
                                    <input class="form-control" type="email" id="example-search-input email" name="email"  pattern="^(([-\w\d]+)(\.[-\w\d]+)*@([-\w\d]+)(\.[-\w\d]+)*(\.([a-zA-Z]{2,5}|[\d]{1,3})){1,2})$" size="30" autocomplete="off" spellcheck="false" required="required">
                            </div> 
                            <div class="form-group">
