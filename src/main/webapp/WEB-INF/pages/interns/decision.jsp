                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Decision</h4>
                            ...
                            <div class="card">
                                <div class="card-body">                  
                                    ...
                                    <div class="table-responsive dash-social">
                                           ...
                                           <p>On interview day,click to make an offer and see who accepted</p>
...
<script>
  ...
  $(document).ready(function(){
	...
	$('#interns').click();
	$("#img-decision").attr("src",path+"/static/assets/images/decision18blue.png");	
