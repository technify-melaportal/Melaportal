                        ...
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">                                  
                                        <li class="breadcrumb-item"><button type="submit" class="button"><h4 class="page-title">I agree</h4></button>
                                          <button type="submit" class="button"><h4 class="page-title">I refuse</h4></button></li>
                                    </ol>
                                </div>
